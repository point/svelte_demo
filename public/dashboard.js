...
(function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(i0, "class", "fa fa-building-o svelte-zndz4j");
    			add_location(i0, file$1, 58, 8, 1152);
    			attr_dev(span0, "class", "title");
    			add_location(span0, file$1, 59, 8, 1193);
    			attr_dev(span1, "class", "arrow open");
    			add_location(span1, file$1, 59, 49, 1234);
    			attr_dev(a0, "href", "#");
    			attr_dev(a0, "class", a0_class_value = "nav-toggle " + (ctx.nav_open ? 'open' : '') + " svelte-zndz4j");
    			attr_dev(a0, "id", "sidebar-org");
    			add_location(a0, file$1, 57, 4, 1015);
    			attr_dev(i1, "class", "fa fa-plus svelte-zndz4j");
    			set_style(i1, "color", "#b4bcc8");
    			add_location(i1, file$1, 64, 20, 1419);
    			attr_dev(span2, "class", "title");
    			add_location(span2, file$1, 65, 16, 1486);
    			attr_dev(a1, "href", "/add-organisation");
    			set_style(a1, "font-weight", "bold");
    			attr_dev(a1, "class", "svelte-zndz4j");
    			add_location(a1, file$1, 63, 16, 1343);
    			attr_dev(li, "class", "nav-item-add svelte-zndz4j");
    			add_location(li, file$1, 62, 12, 1301);
    			attr_dev(ul, "class", "svelte-zndz4j");
    			add_location(ul, file$1, 61, 8, 1284);
    		...
    		p: function update(changed, ctx) {
    			if ((!current || changed.nav_open) && a0_class_value !== (a0_class_value = "nav-toggle " + (ctx.nav_open ? 'open' : '') + " svelte-zndz4j")) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_if_block$1.name, type: "if", source: "(57:4) {#if organizations}", ctx });
    	return block;
    }

    // (69:12) {#each organizations as org}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_each_block.name, type: "each", source: "(69:12) {#each organizations as org}", ctx });
    	return block;
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 55, 0, 959);
    		},
